...
import PopularDonationCardSettings from '../supporting/cards/PopularDonationCardSettings';
...
const PopularDonationsSettings: React.FC<SectionEditorProps> = ({
    settings,
    handleSettingChange,
}) => {
    const objectPath ='sections.donations';
            ...
            <AnimatePresence>
                ...
                {activePanel === "card" && (
                    <SlidingPanel key="card" isOpen={true} onClose={() => setActivePanel("cards")} title="Card Settings">
                        <PopularDonationCardSettings settings={settings} handleSettingChange={handleSettingChange}/>
                    </SlidingPanel>
                )}
...
export default PopularDonationsSettings