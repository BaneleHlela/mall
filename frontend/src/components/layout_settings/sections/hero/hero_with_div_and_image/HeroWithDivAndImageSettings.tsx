                        ...
                        >
                            <div className="px-2 space-y-[.6vh]">
                                ...
                                <TextEditor
                                    ...
                                    settings={settings}
                                    handleSettingChange={handleSettingChange}
                                    allow={["fontFamily", "animation", "textDecoration", "hide", "textTransform", "weight", "input", "width", "fontSize", "lineHeight", "letterSpacing", "color", "padding", "border", "placement", "textAlign", "textMaxWidth", "underline" ]}
                                    responsiveSize
                                    useTextarea
                                    responsivePadding
                                />
