...
interface DashboardFilterByDeliveryOptionProps {
  value?: string;
...
const DashboardFilterByDeliveryOption: React.FC<DashboardFilterByDeliveryOptionProps> = ({
  value,
  onChange,
}) => {
...
export default DashboardFilterByDeliveryOption;