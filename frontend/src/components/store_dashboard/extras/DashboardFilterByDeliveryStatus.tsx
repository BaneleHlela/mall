...
interface DashboardFilterByDeliveryStatusProps {
  value?: string;
...
const DashboardFilterByDeliveryStatus: React.FC<DashboardFilterByDeliveryStatusProps> = ({
  value,
  onChange,
}) => {
...
export default DashboardFilterByDeliveryStatus;