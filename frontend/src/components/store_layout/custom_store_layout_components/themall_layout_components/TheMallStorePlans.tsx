...
const PlanCard = (
    ...
    return (
        <div className="border-t-[.5vh] border-[#6c63ff] rounded-[2vh] p-[2.5vh] bg-white shadow-sm">
            ...
            <button
                className="w-full bg-[#6c63ff] text-white py-2 my-2 mb-5 rounded-[1.5vh] hover:bg-gray-800 transition-colors"
            ...
            <div className="my-5 pl-1">
                {features.map((feature, index) => (
                    <p key={index} className="flex items-start gap-2 my-5">
...
const plans = [
    {
        planName: "pre-launch",
        planDescription: "Our Gift To You For Joining Early!",
        duration: "12 months!",
        price: "R25",
        features: [
...
const TheMallStorePlans = () => {
  return (
    <div className="w-full lg:w-[80%] flex flex-col items-center p-[2vh] lg:p-[4vh] bg-gray-100">
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-3 gap-[2vh] lg:gap-[4vh]">
