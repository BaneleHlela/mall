...
const BasicSearchProductCard: React.FC<StoreProductCardProps> = ({
  title,
  price,
  prices,
  style,
  ...
  return (
    <div 
      ...
      className={`flex group flex-col hover:scale-101 bg-amber-600`}
    >
      {/* Image */}
      <div 
        style={{
...
export default BasicSearchProductCard;
