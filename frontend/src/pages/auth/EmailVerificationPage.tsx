...
const EmailVerificationPage = () => {
	...
	return (
		<motion.div
			...
			className="max-w-[60vh] w-full h-screen lg:h-screen flex flex-col justify-evenly backdrop-filter backdrop-blur-xl lg:rounded-[1vh] shadow-xl overflow-hidden p-[2vh]"
		>
			{/* Banner */}
